...
if __name__ == "__main__":
    ...
    for str in split_string:
        ...
        if str_part[0][0] == "Q":
            ...
            if station_name == "Finish" or station_name == str_part[1]: #if the station has had a previous
