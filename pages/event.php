...
<body>
  ...
  <div>
    ...
    <div style="padding-bottom: 4rem;" id="searchFade">
    </div>

    <div class="events section w-100" style="padding-bottom: 4rem;">
      <div class="row w-100">
        <div class="col-md-6" id="col_devider">
          <div class="nice_text">
            <h1 style="font-family: var(--bs-body-font-family); margin-left: 35%;">Create Event</h1>
          </div>
          <button type="button" onclick="location.href='eventcreate.php'" class="btn btn-primary" style="margin-left: 45%;">Create Event</button>
        </div>

        <div class="col-md-6">
          <h1 class="current_events">
            <div class="nice_text">
              <h1 style="font-family: var(--bs-body-font-family); margin-left: 25%;">Current Event</h1>
            </div>
          </h1>
          <!--Left-->
